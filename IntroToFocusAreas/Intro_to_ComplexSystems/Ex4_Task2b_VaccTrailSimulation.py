...
def SI_simulate(vacc_name, S, S_init, I_init, avg_follow_up_time, k_inf_file_path, actual_infected_num):
    ...
    fig, ax = plt.subplots()
    plt.hist(final_state_I, bins=30)
...
S_biontech = np.array([[-1, -1],
            [0,   1]])
S_init_biontech = 18325.00
I_init_biontech = 0.00
avg_follow_up_time_biontech = 2.222 * 1000.00
k_inf_file_path_biontech = "C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_BERLIN/SEMESTER_I/INTRODUCTION_TO_FOCUS_AREAS/COMPLEX_SYSTEMS/LAB/kinf_Biontech.txt"
actual_infected_num_biontech = 162.00

# Moderna
vacc_name_moderna = "Moderna"
S_moderna = np.array([[-1, -1],
            [0,   1]])
S_init_moderna = 14598.00
I_init_moderna = 0.00
avg_follow_up_time_moderna = 2.56 * 1000.00
k_inf_file_path_moderna = "C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_BERLIN/SEMESTER_I/INTRODUCTION_TO_FOCUS_AREAS/COMPLEX_SYSTEMS/LAB/kinf_Moderna.txt"
actual_infected_num_moderna = 269

# Astra
vacc_name_astra = "Astra Zeneca"
S_astra = np.array([[-1, -1],
            [0,   1]])
S_init_astra = 10792.00
I_init_astra = 0.00
avg_follow_up_time_astra = 64.90/365.00 * 1000.00
k_inf_file_path_astra = "C:/Users/Qba Liu/Documents/STUDIA/BIOINF_MASTER_BERLIN/SEMESTER_I/INTRODUCTION_TO_FOCUS_AREAS/COMPLEX_SYSTEMS/LAB/kinf_Astra.txt"
actual_infected_num_astra = 130.00
